computer
(myvenv) jirayu@jirayu-Vivobook-ASUSLaptop-K5404VA-S5404VA:~$ cd Send_and_Recieve_image/
(myvenv) jirayu@jirayu-Vivobook-ASUSLaptop-K5404VA-S5404VA:~/Send_and_Recieve_image$ python3 Recieve_image_v2.py 
...
(venv) Nemo@Nemorobot:~$ cd Send_and_Recieve_image/
(venv) Nemo@Nemorobot:~/Send_and_Recieve_image$ python3 Send_image_v2.py   
